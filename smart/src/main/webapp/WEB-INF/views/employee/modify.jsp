...
<table class='w-px600'>
	...
	<tr><th>사원명</th>
		<td><input type='text' name='last_name' value='${vo.last_name}'>성
			<input type='text' name='first_name' value='${vo.first_name}'>명
		</td>
	</tr>
	<tr><th>이메일</th>
	...
	<tr><th>입사일자</th>
		<td><input type='text' name='hire_date' value='${vo.hire_date }'></td>
	</tr>
</table>
</form>
